...
const SaleReturn = ({ fromDate, toDate, selectedReport, onClose }) => {
  ...
  useEffect(() => {
    const fetchSalesReturn = async () => {
      try {
        const response = await ApiService.post('/dashboards/getSalesReturns', {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full">
        <h4 className="text-xl font-semibold mb-4">Sales Return Preview</h4>
