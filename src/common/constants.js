...
export const menuOptions = [
  ...
  hasPermission(permission, 'client', 'view') && {
    name: 'Customer',
    icon: <img src="./clients.png" />,
    route: '/clients',
  },
  hasPermission(permission, 'vendor', 'view') && {
    name: 'Vendors',
    icon: <img src="./vendors.png" />,
    route: '/vendors',
  },
  hasPermission(permission, 'assets', 'view') && {
    name: 'Assets',
    icon: <img src="./asserts.png" />,
    route: '/asserts',
  },
  ...
  hasPermission(permission, 'voucher', 'view') && {
    name: 'Ledger',
    icon: <img src="./ledger.png" />,
    route: '/ledger',
  },
  hasPermission(permission, 'staff', 'add') && {
    name: 'Letters',
    icon: <img src="./letters.png" />,
    route: '/letters',
  },
  ...
  (hasPermission(permission, 'voucher', 'view') ||
    role?.toLowerCase() === 'backend support executive') && {
    name: 'Payments',
  ...
  hasPermission(permission, 'voucher', 'view') && {
    name: 'Receipt',
    icon: <img src="./receipt.png" />,
    route: '/receipts',
  },
  hasPermission(permission, 'hiring', 'view') && {
    name: 'Hiring',
    icon: <img src="./hiring.png" />,
    route: '/hiring',
  },
  hasPermission(permission, 'tickets', 'view') && {
    name: 'Tickets',
  ...
  hasPermission(permission, 'services', 'view') && {
    name: 'Service',
    icon: <img src="./service.png" />,
    route: '/service',
  },
