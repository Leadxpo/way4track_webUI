...
export const formattedPaths = {
  ...
  warehouse_manager: {
    ...
    '/returns': { name: 'Returns', icon: <img src="./returns.png" /> },
    '/manage-returns': {
      name: 'Manage Returns',
      icon: <img src="./returns.png" />,
    },
  },
  technician: {
    '/home': { name: 'Home', icon: <img src="./home.png" /> },
  ...
  customer_care: {
    ...
    '/customer-requests': {
      ...
      icon: <img src="./customer_request.png" />,
    },
    ...
    '/complaints': { name: 'Complaints', icon: <img src="./complaint.png" /> },
    '/add-complaint': {
      name: 'Add Complaint',
      icon: <img src="./complaint.png" />,
    },
    '/complaint-details': {
      name: 'Complaint Details',
      icon: <img src="./complaint.png" />,
    },
    '/feedback': { name: 'Feedback', icon: <img src="./feedback.png" /> },
    '/respond-feedback': {
      name: 'Respond to Feedback',
      icon: <img src="./feedback.png" />,
    },
  },
  accountant: {
    '/home': { name: 'Home', icon: <img src="./home.png" /> },
