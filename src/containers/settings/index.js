...
//           setStaffData([staff] || []);  // Store staff data
//         }
//       } catch (error) {
...
//         [permissionType]: !prevData.permissions[permissionType], // Toggle the permission
//       }
//     }));
//   };
...
//                   </thead>
//                   <tbody>
//                     {staffData && staffData.permissions && staffData.permissions.length > 0 ? (
