      ...
      products: [
        {
          ...
          description: "Way4Track offers tracking and monitoring services for your personal vehicle.",
          total: "100",
          inHand: "55",
          remaining: 45,
        },
        {
          ...
          description: "Advanced tracking for cars with live monitoring and alerts.",
          total: "80",
          inHand: "24",
          remaining: 56,
        },
      ...
      products: [
        {
          ...
          description: "Monitor your fleet vehicles with accurate GPS tracking.",
          total: "120",
          inHand: "50",
          remaining: 70,
        },
        {
          ...
          description: "Compact GPS tracker for personal security and asset tracking.",
          total: "90",
          inHand: "40",
          remaining: 50,
        },
      ...
      products: [
        {
          ...
          description: "Keep track of your pets with real-time location updates.",
          total: "60",
          inHand: "30",
          remaining: 30,
        },
        {
          ...
          description: "Ideal for kids and elderly tracking with safety alerts.",
          total: "75",
          inHand: "25",
          remaining: 50,
        },
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          description: "Advanced GPS tracker for marine applications and vessels.",
          total: "50",
          inHand: "20",
          remaining: 30,
        },
                    ...
                    <tbody className="text-gray-700">
                      {branch.products.map((product, i) => (
                        <tr key={product.id} className="border-t border-gray-200">
                          ...
                          <td className="py-4 px-6 font-bold text-lg">{product.remaining}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
