  ...
  return (
    <div className="space-y-10 px-8 py-4">
      ...
      <div className="flex space-x-4 mb-4">
        {["staff", "bank", "assets"].map((tab) => (
          <button
            ...
            className={`px-6 py-2 text-sm w-96 h-12 font-semibold rounded-md shadow ${activeTab === tab ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700"
              }`}
          >
      ...
      <table className="w-full border-collapse border border-gray-300">
        ...
        <tbody>
          {[...branchDetails.staff]
            .sort((a, b) => String(a.staffId).localeCompare(String(b.staffId))).map((staff, index) => (
