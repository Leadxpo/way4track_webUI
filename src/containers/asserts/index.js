...
// const assets = {
//   officeAsserts: [
//     { name: 'Chair', location: 'Kakinada', price: 50000, status: 'Payment Done', statusColor: 'text-green-500' },
//     { name: 'Boss Chair', location: 'Visakhapatnam', price: 35000, status: 'Payment Done', statusColor: 'text-green-500' },
//     { name: 'Manager Chair', location: 'Vijayawada', price: 200000, status: 'Payment Done', statusColor: 'text-green-500' },
//     { name: 'Table & Chair', location: 'Kakinada', price: 50000, status: 'Payment Done', statusColor: 'text-green-500' },
//     { name: 'Office Table', location: 'Vijayawada', price: 50000, status: 'Payment Done', statusColor: 'text-green-500' },
//   ],
//   transportAsserts: [
//     { name: 'Motorbike', location: 'Visakhapatnam', price: 50000, status: '2 EMI Pending', statusColor: 'text-red-500' },
//     { name: 'JCB', location: 'Hyderabad', price: 200000, status: '5 EMI Pending', statusColor: 'text-red-500' },
//   ],
// };
...
//     console.log("Clicked")
//     setSelectedAssets(assets[category]);
//   };
...
//             selectedBranch={selectedBranch}
//             setSelectedBranch={setSelectedBranch}
//             onClick={() => handleCardClick('officeAsserts')}
//           />
//           <button onClick={()=>handleCardClick("officeAsserts")}>Click</button>
//           <DropdownCard
//             bgColor="purple"
//             title="Transport Asserts"
//             count={assetCounts.transportAsserts}
//             branches={branches}
//             selectedBranch={setSelectedBranch}
//             onClick={() => handleCardClick('transportAsserts')}
//           />
//         </div>
//       )}
//       <div style={{display: 'flex',marginLeft: "30px"}}>
