 ...
 const fetchBranchStockDetails = async () => {
  try {
    const payload = {
      ...
      status: "assigned", // explicitly assign this if required by backend
    };
    let response = await ApiService.post("/products/getStockSummary", payload); // 👈 Use the correct route here
