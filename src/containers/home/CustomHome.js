    ...
    setWorkList(
      allWorks.filter((work) => {
        return (
          ...
          (work.phoneNumber &&
            work.phoneNumber.toLowerCase().includes(query)) ||
            ...
            <table className="min-w-full bg-white border border-gray-300 rounded-lg">
              <thead>
                <tr className="bg-blue-500 text-white">
                  <th className="px-6 py-3 text-sm font-bold">Staff Id</th>
            ...
            <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-2xl p-6 max-h-[80vh] overflow-y-auto">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
                  ...
                  <p>
                    <strong>Status:</strong> {selectedStaff.staffStatus}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-2xl p-6 max-h-[80vh] overflow-y-auto">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
                  ...
                  <p>
                    <strong>Status:</strong> {selectedClient.clientStatus}
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
                  <p>
                    ...
                    {selectedClient.contactTime ?? 'N/A'}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    {selectedClient.referralSource ?? 'N/A'}
                  </p>
                </div>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-2xl p-6 max-h-[80vh] overflow-y-auto">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
                  <p>
                    <strong>Work Id:</strong> {selectedWork.workId}
                  </p>
                  <p>
                    <strong>Name:</strong> {selectedWork.name}
                  </p>
                  <p>
                    <strong>Email:</strong> {selectedWork.email}
                  </p>
                  <p>
                    <strong>Phone Number:</strong> {selectedWork.phoneNumber}
                  </p>
                  <p>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
                  ...
                  <p>
                    <strong>End Date:</strong> {selectedWork.endDate ?? 'N/A'}
                  </p>
                  <p>
                    <strong>Assigned To:</strong> {selectedWork.assignedTo}
                  </p>
                  <p>
