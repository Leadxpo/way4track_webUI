...
const BranchManagerHome = () => {
  ...
  const [creditAndDebitPercentages, setCreditAndDebitPercentages] =
    useState(null);
  ...
  const fetchAssertsCardData = async (staff_branchName) => {
    try {
      const response = await ApiService.post('/dashboards/assertsCardData ', {
        branchName: staff_branchName,
        companyCode: initialAuthState?.companyCode,
        unitCode: initialAuthState?.unitCode,
      });
  ...
  return (
    <div className="p-6">
        ...
        >
          ...
          <div className="space-y-4">
            <div className="text-green-600 flex items-center text-xl font-bold">
              ...
              <span className="ml-2">
                {creditAndDebitPercentages &&
                  creditAndDebitPercentages[0].creditPercentage}
                %
              </span>
            </div>
            <div className="bg-gray-200 rounded-full h-6">
              <div
                ...
                style={{
                  width: `${creditAndDebitPercentages && creditAndDebitPercentages[0].creditPercentage}%`,
                }}
              ></div>
            </div>
            ...
            <div className="text-red-500 flex items-center text-xl font-bold">
              ...
              <span className="ml-2">
                {creditAndDebitPercentages &&
                  creditAndDebitPercentages[0].debitPercentage}
                %
              </span>
            </div>
            <div className="bg-gray-200 rounded-full h-6">
              <div
                ...
                style={{
                  width: `${creditAndDebitPercentages && creditAndDebitPercentages[0].debitPercentage}%`,
                }}
              ></div>
            </div>
          </div>
      ...
      <div className="mt-6">
        <Table
          data={productDetailsByBranch ? productDetailsByBranch[0].product : []}
