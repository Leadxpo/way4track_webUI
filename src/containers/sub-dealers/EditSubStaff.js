...
const [personnelDetails, setPersonnelDetails] = useState({});
  ...
  const subDealerStaff = location?.state?.subdealerstaff|| null;

const [formData, setFormData] = useState({
  name:subDealerStaff.name
  ,
  dob: subDealerStaff.dob  ,
  gender: subDealerStaff.
  gender,
  phoneNumber:subDealerStaff.phoneNumber
  ,
  alternateNumber:subDealerStaff.
  alternateNumber,
  email:subDealerStaff.
  email
  ,
  aadharNumber:subDealerStaff.
  aadharNumber,
  panCardNumber:subDealerStaff.
  panCardNumber,
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (response.status) {
      alert("Subdealer Staff details Staff Updated successfully!");
navigate("/sub-staff-details");
    } else {
      alert("Failed to update Subdealer Staff details.");
    }
  } catch (error) {
