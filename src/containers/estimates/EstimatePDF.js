...
//   // Add this one new style for bank info spacing
//   bankInfo: {
//     fontSize: 9,
//     fontFamily: 'Helvetica',
//     marginTop: 2,
...
//           <Text style={estStyles.totalBlockLeftText3}>
//             Total In Words: Indian Rupee {toWords.convert(data.grandTotal, { currency: true })}
//           </Text>
//         </View>
...
//         <View style={estStyles.signatureBlock}>
//           <Text style={estStyles.signatureText}>For Sharon Telematics Pvt. Ltd.</Text>
//           <Text style={estStyles.signatureTextBottom}>Authorized Signature</Text>
//         </View>

//         {/* Notes and Bank Info */}
//         <View style={{ marginTop: 10, paddingLeft: 5 }}>
//           <Text style={estStyles.totalBlockLeftText1}>Notes</Text>
//           <Text style={estStyles.bankInfo}>Looking forward for your business.</Text>

//           <Text style={[estStyles.totalBlockLeftText1, { marginTop: 10 }]}>Terms & Conditions</Text>

//           <Text style={[estStyles.totalBlockLeftText1, { marginTop: 10 }]}>Bank Details:</Text>
//           <Text style={estStyles.bankInfo}>Payment To: Sharon Telematics Pvt Ltd., Visakhapatnam</Text>
//           <Text style={estStyles.bankInfo}>Payment Mode: By Cash / NEFT / RTGS / Cheque</Text>
//           <Text style={estStyles.bankInfo}>- A/c No: 131905001314</Text>
//           <Text style={estStyles.bankInfo}>- Bank Name: ICICI Bank</Text>
//           <Text style={estStyles.bankInfo}>- Branch Name: BUTCHIRAJU PALAM</Text>
//           <Text style={estStyles.bankInfo}>- Bank Address: BUTCHIRAJU PALAM - 5300027</Text>
//           <Text style={estStyles.bankInfo}>- IFSC Code: ICIC0001319</Text>
//         </View>
